...
import { useGetUserFollowersQuery } from "@/store/follow/followApi";

const UserFollowers = () => {
    const { id } = useParams();
    const { data: response, isLoading, error } = useGetUserFollowersQuery(Number(id));
    ...
    return (
        <div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-light-1 mb-6">Followers</h2>
